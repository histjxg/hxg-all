package com.suixingpay.profit.jikeshijian.xiengnengyouhua;
...
public class IOOrCPUTypeTest {
    // 初始化线程池
    private static ThreadPoolExecutor threadPool = new ThreadPoolExecutor(8, 8, 10, TimeUnit.SECONDS, new ArrayBlockingQueue<>(1000), new ThreadPoolExecutor.DiscardOldestPolicy());
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException, TimeoutException {
        ...
        for (int i = 0; i < requestNum; i++) {
            Future<?> future = threadPool.submit( new CPUTypeTest18(runTimeList, wholeTimeList));
