package com.suixingpay.profit.atguigu.priciple.demeter.improve;
...
class CollegeSchoolManager{
    ...
    public void printEmployee(CollegeSchoolManager sub) {
...
class SchoolManager{
    ...
    public void printAllEmployee(CollegeSchoolManager sub){
        ...
        //违法了迪米特法则
        //解决办法，经输出学院的员工方法，封装到CollegeSchoolManager
        sub.printEmployee(sub);
